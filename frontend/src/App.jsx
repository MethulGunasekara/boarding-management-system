...
import OwnerProfiles      from './pages/admin/OwnerProfiles';
  ...
  return (
    <AuthProvider>
      <Router>
        <Toaster
          position="top-right"
          toastOptions={{ style: { background: 'var(--bg-card)', color: 'var(--text-main)', border: '1px solid var(--border-color)' } }}
        />
        <Routes>
          {/* Public */}
          ...
          <Route path="/admin/plans"       element={<PL roles={['ADMIN']}><PlanManager /></PL>} />
          <Route path="/admin/owners"      element={<PL roles={['ADMIN']}><OwnerProfiles /></PL>} />
